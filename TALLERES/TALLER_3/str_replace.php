...
$miFrase = "PHP es un lenguaje fuerte,PHP es útil,PHP es único"; // Reemplaza esto con tu frase
...
//bonus ejemplo
$mitexto = "Edgar y Esther son programadores. Estudian en la UTP.";
$buscartexto = ["Edgar", "UTP"];
$reemplazartexto = ["Emily", "Universidad Tecnológica de Panamá"];
$textoModificadotexto = str_replace($buscartexto, $reemplazartexto, $mitexto);

echo "</br>Texto original: $mitexto</br>";
echo "Texto modificado: $textoModificadotexto</br>";
?>
