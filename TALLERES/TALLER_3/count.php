...
$misCanciones = ["Beso","Algo magico","Amor de mi vida","vida","Cielo"]; // Reemplaza esto con tu array de canciones
...
//bonus estudiante
$playlist = [
    "Regueton" => ["Gasolina", "Calle"],
    "Típico" => ["El amor de vida", "Paso a Paso", "Tristeza"],
    "jazz" => ["Take Five", "So What"]
];
