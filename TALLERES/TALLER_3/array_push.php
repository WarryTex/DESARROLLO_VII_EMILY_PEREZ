...
$misAmigos = ["Emily","Irenis"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Emily", "Irenis"); // Reemplaza las comillas vacías con los nombres de tus amigos
...
array_push($playlist, ["Billie", "Jackson"], ["Like ", "Dylan"]);
