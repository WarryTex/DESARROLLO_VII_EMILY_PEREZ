...
$misComidas = ["Tamal", "Arroz con puerco", "Arroz con pollo"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Saus", "Sopa china", "Macarrones"]; // Reemplaza con las comidas favoritas de tu amigo
...
$array1 = ["a" => "rojo", "b" => "verde","c"=> "morado"];
...
$numeros5 = [13, 14, 15];
$numeros6 = [16, 17, 18];
$todosLosNumeros = array_merge($numeros4, $numeros5, $numeros6);
echo "</br>Todos los números combinados:</br>";
print_r($todosLosNumeros);
