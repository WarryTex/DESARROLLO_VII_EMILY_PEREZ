...
$peliculaFavorita = [
    ...
    "año" => 2023,
    "actores" => ["Nicole Wallace", "Gabriel Guevara", "Marta Hazas"]
];
...
$miLibro = new Libro1("El Principito", "Antoine de Saint-Exupéry", 1943);
$jsonLibro = json_encode($miLibro, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);

echo "</br>Objeto Libro en JSON:</br><pre>$jsonLibro</pre>";
