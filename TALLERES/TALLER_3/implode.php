...
$paises = ["Honduras","Jamaica","México","Colombia","PuertoRico"]; // Reemplaza esto con tu array de países
...
$infomiPersona = implode(" | ", $mipersona);

echo "</br>Información de la persona: $infomiPersona</br>";
?>
