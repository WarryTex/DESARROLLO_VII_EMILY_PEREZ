...
$miArray = ["Camisa","Pantalon","Zapato"]; // Reemplaza esto con tu propio array
$miString = "Emily"; // Reemplaza esto con tu propio string
$miNumero = 25; // Reemplaza esto con tu propio número
...
echo "</br>Pruebas de la función procesarDato():</br>";
procesarDatos([1, 2, 3]);
procesarDatos("Hola,practicando");
procesarDatos(1000);
?>
