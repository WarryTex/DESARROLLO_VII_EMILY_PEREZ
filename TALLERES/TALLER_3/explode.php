...
$misPeliculas = "Culpa mia-culpa tuya-culpa nuestra-Titanic-Rápido y Furioso"; // Reemplaza esto con tu lista de películas
...
//bonus ejemplo estudiante
$frase="lapiz,papel,hoja,libreta,borrador,boligrafo";
$array=explode("," , $frase, 2);

echo "</br>Texto original: $frase</br>";
echo "Array con límite:</br>";
print_r($array);
