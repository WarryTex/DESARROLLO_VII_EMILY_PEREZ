...
// Practica 
$texto1 = "Hola taller3";
$extracto3 = substr($texto1, 3, 7);  // Extrae desde la posición 0, 4 caracteres
$extracto4 = substr($texto1, 5);     // Extrae desde la posición 5 hasta el final

echo "Texto original: $texto1</br>";
echo "Extracto 1: $extracto3</br>";
echo "Extracto 2: $extracto4</br>";
...
// Bonus: Ocultar parte de un número de tarjeta de crédito MODIFICADO
...
//practica 
$correo = "emily.perez@hotmail.com";
echo "</br>Correo electrónico: $correo</br>";
echo "Dominio: " . extraerDominio($correo) . "</br>";
...
$textoHTML = "<h1>Título Principal y secundario</h1>";
