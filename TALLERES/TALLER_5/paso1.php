...
// 9. Función que cuente y retorne el número de ciudades que comienzan con una letra específica
...
echo "Número de ciudades que empiezan con 'N': " . contarCiudadesPorInicial($ciudades, 'N') . "\n";
?>
