...
[$crecimientos, $mayorCrecimiento] = analizarCrecimiento($ventas);
...
echo "\nMayor crecimiento: {$mayorCrecimiento['producto']} en {$mayorCrecimiento['region']} con " 
     . number_format($mayorCrecimiento['crecimiento'], 2) . "%\n";
